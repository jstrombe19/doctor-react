    ...
    return(
      <div id="app">
        <section id="favorite-doctors-container">
          ...
          <FavoriteDoctors 
            key={1} 
            doctors={this.state.favoriteDoctors} 
            doctorAction={this.removeDoctorFromFavorites} 
          />
        </section>
        <section id="doctor-list">
          ...
          <DoctorContainer 
            ...
            doctorAction={this.addDoctorToFavorites} 
            dischargeDoc={this.dishcargeDoc}  
          />
        </section>
      </div>
    )
